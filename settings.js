...
(function() {
  ...
  function formatDateTime(isoStr) {
    try {
      const dt = new Date(isoStr.replace(' ', 'T') + (isoStr.includes('Z') ? '' : 'Z'));
  ...
  settingsBackBtn.addEventListener('click', function() {
    ...
    setTimeout(function() {
      ...
      // Возвращаем кнопку шестерёнки (её видимость теперь управляется классом .visible)
  ...
  confirmYesBtn.addEventListener('click', function() {
    ...
    setTimeout(function() {
      ...
      // Скрываем все кнопки интерфейса
